...
<head>
    ...
    <title>Panels | Nifty - Responsive admin template.</title>
        	...
        	<div class="panel panel-colorful panel-primary">
                ...
                <div class="panel-body" style="height:500px !important;">
                    <div class="panel panel-bordered-primary">                        
                        <div class="panel-body" style="height:450px !important;">             
                            
                            <div class="panel panel-colorful panel-primary">
								<div class="panel-body" style="height:400px !important;">
                                <div style="text-align:center; padding-top:300px">
                                	<button class="btn btn-default btn-lg btn-labeled fa fa-user">Logging</button>
                                </div>
								</div>
							</div>                            
                        </div>
